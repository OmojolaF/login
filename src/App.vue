      ...
      <div class="sm:mx-auto bg-white px-9 py-4 my-10 mx-5 rounded-md sm:px-14 sm:py-8 max-w-lg">
        <div class="max-w-md mx-auto">
          ...
          <div class="placeholder-gray-800::placeholder">
            ...
            <div class="py-2">
              <input type="checkbox" name="remember" id="customCheck" class="focus:outline-none focus:ring-2 leading-6"/><label for="customCheck" class="mx-2 font-normal leading-6 text-sm text-purple">Remember Me</label>
            </div>
            </form> 
